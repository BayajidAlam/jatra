...
export class TrainsController {
  ...
  @ApiResponse({
    status: 200,
    description: "List of all active trains with coaches and seats",
  })
  findAll() {
  ...
  @ApiResponse({
    status: 200,
    description: "Train details with coaches, seats, and upcoming journeys",
  })
  ...
  @ApiParam({
    name: "trainNumber",
    description: "Train number (e.g., SUBORNO-EXPRESS-701)",
  })
