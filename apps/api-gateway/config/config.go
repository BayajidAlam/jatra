...
func LoadConfig() {
	...
	AppConfig = &Config{
		...
		JWTAccessSecret:           getEnv("JWT_ACCESS_SECRET", "your-access-token-secret-change-in-production"),
		JWTRefreshSecret:          getEnv("JWT_REFRESH_SECRET", "your-refresh-token-secret-change-in-production"),
		...
		CORSAllowedOrigins:        strings.Split(getEnv("CORS_ALLOWED_ORIGINS", "http://localhost:3001,http://localhost:5173,http://localhost:3000"), ","),
