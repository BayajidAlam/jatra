...
export class PaymentsController {
  ...
  @ApiOperation({
    ...
    description:
      "Initialize a payment for a reservation through mock gateway. Supports idempotency via Idempotency-Key header to prevent duplicate charges.",
  })
  @ApiHeader({
  ...
  @ApiOperation({
    ...
    description:
      "Retrieve all payments for a specific user with filters and pagination",
  })
  @ApiParam({
    name: "userId",
    description: "User ID",
